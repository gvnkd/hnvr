...
data Camera' ptzHomePresetId = Camera {id :: (Id' "cameras"), slug :: Text, name :: Text, rtspUrl :: Text, rtspTransport :: Text, host :: (Maybe Text), username :: (Maybe Text), passwordEnc :: (Maybe (Binary ByteString)), passwordNonce :: (Maybe (Binary ByteString)), codec :: CodecKind, rtspSubUrl :: (Maybe Text), useSubstreamForAnalysis :: Bool, substreamCodec :: CodecKind, substreamWidth :: (Maybe Int), substreamHeight :: (Maybe Int), recordAudio :: Bool, analysisFps :: Int, modelName :: Text, enabled :: Bool, retentionHours :: Int, assignedHost :: (Maybe Text), manualAssign :: Bool, onvifPort :: (Maybe Int), mgmtProto :: Text, mainVideoEncoding :: (Maybe Text), mainVideoWidth :: (Maybe Int), mainVideoHeight :: (Maybe Int), mainVideoFps :: (Maybe Int), mainVideoBitrateKbps :: (Maybe Int), mainVideoGovLength :: (Maybe Int), subVideoEncoding :: (Maybe Text), subVideoWidth :: (Maybe Int), subVideoHeight :: (Maybe Int), subVideoFps :: (Maybe Int), subVideoBitrateKbps :: (Maybe Int), subVideoGovLength :: (Maybe Int), audioEncoding :: (Maybe Text), audioBitrateKbps :: (Maybe Int), audioSampleRateKhz :: (Maybe Int), ptzEnabled :: Bool, ptzProfileToken :: (Maybe Text), ptzHomePresetId :: ptzHomePresetId, ptzIdleTimeoutS :: Int, ptzViewerControl :: Bool, snapshotIntervalSec :: Int, createdAt :: UTCTime, updatedAt :: UTCTime, meta :: MetaBag} deriving (Eq, Show)

type Camera = Camera' (Maybe (Id' "ptz_presets"))

type instance GetTableName (Camera' _) = "cameras"
type instance GetModelByTableName "cameras" = Camera


instance IHP.ModelSupport.Table (Camera' ptzHomePresetId) where
    tableName = "cameras"
