...
data Host' = Host {id :: (Id' "hosts"), displayName :: Text, gpuModel :: (Maybe Text), execProviders :: [Text], isLeader :: Bool, lastHealthAt :: (Maybe UTCTime), healthJson :: (Maybe Data.Aeson.Value), createdAt :: UTCTime, meta :: MetaBag} deriving (Eq, Show)
...
instance IHP.ModelSupport.Table (Host') where
    tableName = "hosts"
    columnNames = ["id","display_name","gpu_model","exec_providers","is_leader","last_health_at","health_json","created_at"]
