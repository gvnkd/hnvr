...
module Generated.Statements.FetchSegment (statement) where
...
statement :: Statement.Statement (Id' "segments") (Maybe Generated.ActualTypes.Segment)
...
decoder :: Decoders.Result (Maybe Generated.ActualTypes.Segment)
