...
module Generated.Statements.FetchCameraSnapshot (statement) where
...
statement :: Statement.Statement (Id' "camera_snapshots") (Maybe Generated.ActualTypes.CameraSnapshot)
statement = Statement.preparable sql encoder decoder

sql :: Text
sql = "SELECT id, camera_id, ts, object_key, bytes, created_at FROM camera_snapshots WHERE id = $1 LIMIT 1"

encoder :: Encoders.Params (Id' "camera_snapshots")
encoder = Encoders.param (Encoders.nonNullable Mapping.encoder)

decoder :: Decoders.Result (Maybe Generated.ActualTypes.CameraSnapshot)
