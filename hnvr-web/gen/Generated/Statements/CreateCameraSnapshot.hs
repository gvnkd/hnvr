...
module Generated.Statements.CreateCameraSnapshot (statement, discardResultStatement) where
...
sql touchedFields returning =
    ...
    in if null entries
        then "INSERT INTO camera_snapshots DEFAULT VALUES" <> returningClause
        else "INSERT INTO camera_snapshots (" <> columns <> ") VALUES (" <> placeholders <> ")" <> returningClause
