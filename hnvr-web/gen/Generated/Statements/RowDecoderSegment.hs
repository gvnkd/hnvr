...
module Generated.Statements.RowDecoderSegment (rowDecoder) where
...
import GHC.Records
rowDecoder :: Decoders.Row Generated.ActualTypes.Segment
rowDecoder = do
    id <- Decoders.column (Decoders.nonNullable Mapping.decoder)
    cameraId <- Decoders.column (Decoders.nonNullable Decoders.uuid)
    startTs <- Decoders.column (Decoders.nonNullable Decoders.timestamptz)
    endTs <- Decoders.column (Decoders.nonNullable Decoders.timestamptz)
