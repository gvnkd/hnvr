...
module Generated.Statements.CreateEventClipEvent (statement, discardResultStatement) where
...
sql touchedFields returning =
    ...
    in if null entries
        then "INSERT INTO event_clip_events DEFAULT VALUES" <> returningClause
        else "INSERT INTO event_clip_events (" <> columns <> ") VALUES (" <> placeholders <> ")" <> returningClause
