...
rowDecoder = do
    ...
    pure (let theRecord = Generated.ActualTypes.Rule id cameraId name kind geometry classes cooldownMs enabled createdAt updatedAt def { originalDatabaseRecord = Just (Data.Dynamic.toDyn theRecord) } in theRecord)
