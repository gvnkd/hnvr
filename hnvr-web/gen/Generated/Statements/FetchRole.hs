...
module Generated.Statements.FetchRole (statement) where
...
statement :: Statement.Statement (Id' "roles") (Maybe Generated.ActualTypes.Role)
statement = Statement.preparable sql encoder decoder

sql :: Text
sql = "SELECT id, name, description, is_system, created_at FROM roles WHERE id = $1 LIMIT 1"

encoder :: Encoders.Params (Id' "roles")
encoder = Encoders.param (Encoders.nonNullable Mapping.encoder)

decoder :: Decoders.Result (Maybe Generated.ActualTypes.Role)
