...
module Generated.Statements.CreateManySegment (statement) where
...
singleEncoder :: Integer -> Encoders.Params Generated.ActualTypes.Segment
singleEncoder touchedFields = mconcat $ catMaybes
    ...
    , Just ((.startTs) >$< Encoders.param (Encoders.nonNullable Encoders.timestamptz))
    , Just ((.endTs) >$< Encoders.param (Encoders.nonNullable Encoders.timestamptz))
