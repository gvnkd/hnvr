...
module Generated.Statements.CreatePtzAuditLog (statement, discardResultStatement) where
...
sql touchedFields returning =
    ...
    in if null entries
        then "INSERT INTO ptz_audit_log DEFAULT VALUES" <> returningClause
        else "INSERT INTO ptz_audit_log (" <> columns <> ") VALUES (" <> placeholders <> ")" <> returningClause
