...
module Generated.Statements.CreateManyPtzPreset (statement) where
...
sql touchedFieldsList =
    ...
    in "INSERT INTO ptz_presets (id, camera_id, name, onvif_token, pantilt_x, pantilt_y, zoom, is_home, created_at) VALUES "
        <> Text.intercalate ", " valueGroups
        <> " RETURNING id, camera_id, name, onvif_token, pantilt_x, pantilt_y, zoom, is_home, created_at"
  where
    columnMeta = [(0, True), (1, False), (2, False), (3, False), (4, False), (5, False), (6, False), (7, True), (8, True)]
...
singleEncoder :: Integer -> Encoders.Params Generated.ActualTypes.PtzPreset
