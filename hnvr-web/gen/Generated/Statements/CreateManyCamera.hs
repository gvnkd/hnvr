...
sql touchedFieldsList =
    ...
    in "INSERT INTO cameras (id, slug, name, rtsp_url, rtsp_transport, host, username, password_enc, password_nonce, codec, rtsp_sub_url, use_substream_for_analysis, substream_codec, substream_width, substream_height, record_audio, analysis_fps, model_name, enabled, retention_hours, assigned_host, manual_assign, onvif_port, mgmt_proto, main_video_encoding, main_video_width, main_video_height, main_video_fps, main_video_bitrate_kbps, main_video_gov_length, sub_video_encoding, sub_video_width, sub_video_height, sub_video_fps, sub_video_bitrate_kbps, sub_video_gov_length, audio_encoding, audio_bitrate_kbps, audio_sample_rate_khz, ptz_enabled, ptz_profile_token, ptz_home_preset_id, ptz_idle_timeout_s, ptz_viewer_control, snapshot_interval_sec, created_at, updated_at) VALUES "
        <> Text.intercalate ", " valueGroups
        <> " RETURNING id, slug, name, rtsp_url, rtsp_transport, host, username, password_enc, password_nonce, codec, rtsp_sub_url, use_substream_for_analysis, substream_codec, substream_width, substream_height, record_audio, analysis_fps, model_name, enabled, retention_hours, assigned_host, manual_assign, onvif_port, mgmt_proto, main_video_encoding, main_video_width, main_video_height, main_video_fps, main_video_bitrate_kbps, main_video_gov_length, sub_video_encoding, sub_video_width, sub_video_height, sub_video_fps, sub_video_bitrate_kbps, sub_video_gov_length, audio_encoding, audio_bitrate_kbps, audio_sample_rate_khz, ptz_enabled, ptz_profile_token, ptz_home_preset_id, ptz_idle_timeout_s, ptz_viewer_control, snapshot_interval_sec, created_at, updated_at"
  where
    columnMeta = [(0, True), (1, False), (2, False), (3, False), (4, True), (5, False), (6, False), (7, False), (8, False), (9, True), (10, False), (11, True), (12, True), (13, False), (14, False), (15, True), (16, True), (17, True), (18, True), (19, True), (20, False), (21, True), (22, False), (23, True), (24, False), (25, False), (26, False), (27, False), (28, False), (29, False), (30, False), (31, False), (32, False), (33, False), (34, False), (35, False), (36, False), (37, False), (38, False), (39, True), (40, False), (41, False), (42, True), (43, True), (44, True), (45, True), (46, True)]
...
singleEncoder touchedFields = mconcat $ catMaybes
    ...
    , if testBit touchedFields 39 then Just ((.ptzEnabled) >$< Encoders.param (Encoders.nonNullable Encoders.bool)) else Nothing
    , Just ((.ptzProfileToken) >$< Encoders.param (Encoders.nullable Encoders.text))
    , Just ((.ptzHomePresetId) >$< Encoders.param (Encoders.nullable Mapping.encoder))
