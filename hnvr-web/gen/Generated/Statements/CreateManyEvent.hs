...
module Generated.Statements.CreateManyEvent (statement) where
...
sql touchedFieldsList =
    ...
    in "INSERT INTO events (id, camera_id, rule_id, ts, kind, class_id, track_id, confidence, bbox, thumbnail_key, segment_ts, host_id, payload, created_at) VALUES "
        <> Text.intercalate ", " valueGroups
        <> " RETURNING id, camera_id, rule_id, ts, kind, class_id, track_id, confidence, bbox, thumbnail_key, segment_ts, host_id, payload, created_at"
  where
    columnMeta = [(0, True), (1, False), (2, False), (3, False), (4, False), (5, False), (6, False), (7, False), (8, False), (9, False), (10, False), (11, False), (12, False), (13, True)]
...
singleEncoder :: Integer -> Encoders.Params Generated.ActualTypes.Event
