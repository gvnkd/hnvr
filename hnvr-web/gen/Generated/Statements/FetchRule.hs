...
module Generated.Statements.FetchRule (statement) where
...
statement :: Statement.Statement (Id' "rules") (Maybe Generated.ActualTypes.Rule)
...
decoder :: Decoders.Result (Maybe Generated.ActualTypes.Rule)
