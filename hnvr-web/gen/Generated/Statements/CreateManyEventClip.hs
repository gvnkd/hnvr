...
module Generated.Statements.CreateManyEventClip (statement) where
...
sql touchedFieldsList =
    ...
    in "INSERT INTO event_clips (id, camera_id, rule_id, started_at, duration_sec, object_prefix, retention_hours, pending_delete_at, created_at) VALUES "
        <> Text.intercalate ", " valueGroups
        <> " RETURNING id, camera_id, rule_id, started_at, duration_sec, object_prefix, retention_hours, pending_delete_at, created_at"
  where
    columnMeta = [(0, True), (1, False), (2, False), (3, False), (4, False), (5, False), (6, False), (7, False), (8, True)]
...
singleEncoder :: Integer -> Encoders.Params Generated.ActualTypes.EventClip
