  ...
  config = lib.mkIf cfg.enable {
    ...
    systemd.services.mediamtx = {
      ...
      preStart = ''
        ...
        # "Auto-generated by HNVR MediaMTXConfigSyncer" header — never
        # clobber it, or camera paths are lost on every mediamtx restart.
        if [ ! -f ${cfg.configPath} ] || ! grep -q 'MediaMTXConfigSyncer' ${cfg.configPath}; then
